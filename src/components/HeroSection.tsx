...
const HeroSection = () => {
  ...
  const fullText = "Aspiring Software Developer | AI & Data Science Enthusiast";
        ...
        <AnimatedSection>
          <div className="flex-1 text-center lg:text-left">
            <h1 className="font-display text-5xl sm:text-6xl lg:text-7xl font-bold mb-4">
              Hi, I'm <span className="gradient-text">Divya</span> 👋
            </h1>
            ...
            <p className="text-lg text-muted-foreground mb-8 max-w-lg mx-auto lg:mx-0">
              Motivated and detail-oriented developer with strong programming and analytical skills, passionate about building intelligent and efficient solutions.
            </p>
